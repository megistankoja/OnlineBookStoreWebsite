...
<body>
        ...
        <div class="row">
            ...
            <div class="content">
                ...
                <p style="color:white; font-size:20px;"> Blini libra te rinj dhe te perdorur,online dhe ne dyqan vetem
                    tek Bookflix and Chill me qender ne qytetin e bukur te Shkodrës!</p>
            </div>

            <div class="swiper books-slider">
                <div class="swiper-wrapper">
                    <a href="shop.php" class="swiper-slide"><img src="images/wind name.jpg" alt=""></a>
                    <a href="shop.php" class="swiper-slide"><img src="images/birdbox2.jpg" alt=""></a>
                    <a href="shop.php" class="swiper-slide"><img src="images/bone1.jpg" alt=""></a>
                    <a href="shop.php" class="swiper-slide"><img src="images/november1.jpg" alt=""></a>
                    <a href="shop.php" class="swiper-slide"><img src="images/Hamlet.jpg" alt=""></a>
                    <a href="shop.php" class="swiper-slide"><img src="images/duke1.jpg" alt=""></a>
    ...
    <section class="icons-container">
        ...
        <div class="icons">
            ...
            <div class="content">
                <h3 ><a href="contact.php">24/7 suport</a></h3>
   ...
   <div class="load-more" style="margin-top: 2rem; text-align:center">
    ...
    <section class="newsletter">
        ...
        <form action="">
            <h3>Beni subscribe per te rejat e fundit</h3>
            <input type="email" name="" placeholder="shkruani emailin" id="" class="box">
